package dev.spiritstudios.cantilever.config;
...
public class CantileverDiscordConfig extends ReflectiveConfig {
	// Configuration for any information Discord requires to accept messages from Cantilever.

	public static final CantileverDiscordConfig INSTANCE = CantileverDiscordConfig.createToml(FabricLoader.getInstance().getConfigDir(), "cantilever", "discord", CantileverDiscordConfig.class);
